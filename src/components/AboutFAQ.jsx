...
const cities = [
  ...
  'Mumbai', 'Delhi NCR', 'Visakhapatnam', 'Guntur', 'Kochi',
  'Dubai', 'Qatar', 'Australia', 'Oman', 'Sri Lanka',
];
        ...
        <div className="footer-top">
          ...
          <div className="footer-brand-col">
            ...
            <div className="footer-cities-block">
              <h4 className="footer-cities-heading">Top Sports Complexes in Cities</h4>
              <div className="cities-grid">
                {visibleCities.map((city) => (
                  <button key={city} className="city-btn">{city} ∨</button>
                ))}
              </div>
              <button
                className="cities-toggle"
                onClick={(e) => { e.stopPropagation(); setShowAllCities(!showAllCities); }}
              >
